package com.cascoArcilla.courseadroid.exercise
...
fun printNotificationSummary(notifacations: Int) {
    if (notifacations < 100) {
        println("You have $notifacations notifications.")
    } else {
